...
public class BodyMasterController {
	...
	public BodyMasterController(BodyMasterService bodyMasterService) {
		this.bodyMasterService = bodyMasterService;
	}

	@GetMapping("/body-masters/view")
	public String showBodyMasterList(Model model) {
	...
	public String createBodyMaster(BodyMaster bodyMaster) {
	...
	public String showBodyMasterDetail(@PathVariable Long id, Model model) {
		model.addAttribute("bodyMaster", bodyMasterService.getBodyMasterById(id));
